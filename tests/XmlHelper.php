...
class XmlHelper
{
    ...
    public function orderData(array $overrideKeys = [])
    {
        ...
        $arr = [
            ...
            "PatientDetail" => [
                ...
                "OrderId" => "63fe07a91417adad096695c2",
            ],
            "Prescription" => [
                ...
                "Prescriber" => [
                    "Doctor" => [
                        "GMCNO" => "4624794",
                        "DoctorName" => "Dr. Daniel Atkinson",
                    ],
                ],
                "Product" => [
                    "Guid" => "5d19fe09302598201c5eacd5",
                    "ProductCode" => "8882821",
                    "Description" => "sildenafil UK 25mg",
                    "ProductQuantity" => [
                        "Quantity" => "1",
                        "Units" => "Tablets",
                        "Dosage" => "1",
        ...
        if (!empty($overrideKeys)) {
            foreach ($overrideKeys as $key => $val) {
                Arr::set($arr, $key, $val);
            }
        }
    ...
    public function generateOrderXML($overrideKeys = [])
    {
        $arr = $this->orderData($overrideKeys);
        return Generic::arrayToXml($arr, new SimpleXMLElement('<ESAPrescription/>'));
    }

    public function generateOrderJSON($overrideKeys = [])
    {
        return json_encode($this->orderData($overrideKeys));
    }
}
