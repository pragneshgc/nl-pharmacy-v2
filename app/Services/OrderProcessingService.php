...
class OrderProcessingService
{
    ...
    public function validateOrderRequest()
    {
        ...
        if (!$client) {
            ...
            Log::channel('import')->info("Using following details(username,ip): $username , $ipaddress");
    ...
    public function process()
    {
        ...
        $prescription = new PrescriptionService($this->data);
        $productService = new ProductService();
        $questionnaire = new QuestionService();
