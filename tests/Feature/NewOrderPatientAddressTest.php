...
class NewOrderPatientAddressTest extends TestCase
{
    ...
    /** @test */
    public function show_error_invalid_delivery_addresslines()
    {
    ...
    /** @test */
    public function show_error_too_long_delivery_addressline1()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function show_error_too_long_delivery_addressline2()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function show_error_too_long_delivery_addressline3()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function show_error_too_long_delivery_addressline4()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function show_error_for_invalid_delivery_contrycode()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function show_error_for_invalid_delivery_postcode()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function show_error_delivery_country_inactive_if_notset()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
    ...
    /** @test */
    public function show_error_delivery_country_inactive_if_set_and_inactive()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
    ...
    /** @test */
    public function proccess_order_if_addressline1_not_empty()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function proccess_order_if_addressline2_not_empty()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function proccess_order_if_addressline3_not_empty()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
