...
class OrderStatusTest extends TestCase
{
    ...
    /** @test */
    public function change_order_new_to_onhold_awaiting_stock()
    {
        $this->addSafeIP('10.1.0.1');
        $this->userLogin();
        $id = $this->newOrder();
    ...
    /** @test */
    public function change_order_new_to_cancel_test_order()
    {
        $this->addSafeIP('10.1.0.1');
        $this->userLogin();
        $id = $this->newOrder();
    ...
    /** @test */
    public function change_order_cancel_to_onhold()
    {
        $this->addSafeIP('10.1.0.1');
        $this->userLogin();
        $id = $this->newOrder();
    ...
    /** @test */
    public function change_order_onhold_to_cancel()
    {
        $this->addSafeIP('10.1.0.1');
        $this->userLogin();
        $id = $this->newOrder();
    ...
    /** @test */
    public function change_order_cancelled_to_cancelled()
    {
        $this->addSafeIP('10.1.0.1');
        $this->userLogin();
        $id = $this->newOrder();
        ...
        $response = $this->postJson("order-edit/$id/status", ['status' => '62']);

        $response->assertJson(['message' => "Prescription $id updated to status CANCELLED - Duplicate XML"]);
        $this->assertDatabaseHas('Prescription', [
            'PrescriptionID' => $id,
            'Status' => OrderStatus::CANCELLED->value,
        ]);
    ...
    /** @test */
    public function change_order_onhold_to_onhold()
    {
        $this->addSafeIP('10.1.0.1');
        $this->userLogin();
        $id = $this->newOrder();
        ...
        $response = $this->postJson("order-edit/$id/status", ['status' => '104']);

        $response->assertJson(['message' => "Prescription $id updated to status ONHOLD - Out of stock"]);
        $this->assertDatabaseHas('Prescription', [
            'PrescriptionID' => $id,
            'Status' => OrderStatus::ONHOLD->value,
        ]);
