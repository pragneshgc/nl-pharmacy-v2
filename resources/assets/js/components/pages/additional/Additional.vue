            ...
            <div class="products-header mb-10">
                <div class="products-navigation">
                    <div class="products-buttons" style="display: flex; align-items: center; justify-content: center;">
                        <button title="Add New Cautionary and Advisory Label" class="btn btnSize02 secondaryBtn mt-10 ml-10"
                            @click="addGroup()">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody v-for="(v, k) in groupedLabels" :key="k" v-if="labels.length > 0">
                                    ...
                                    <div v-else>
                                        <ul>
                                            <li style="padding-bottom: 10px; padding-top: 10px;">
                                                <div
                                                    style="display: flex; justify-content:flex-start; align-items: center;">
                                                    <treeselect v-model="productsAdd[v.group]" :disable-branch-nodes="true"
                                                        placeholder="Select Product" :show-count="true"
                                                        :default-expand-level="1" :load-options="loadOptions" :async="true"
                                                        :append-to-body="false" :disabled="loading" />
                            ...
                            <tr v-for="(value) in v.array" :key="value.ProductCodeID">
                                ...
                                <td v-if="value.editing" style="padding-left: 15px!important; max-width: 120px!important;">
                                ...
                                <td>
                                    <div style="padding: 10px;" v-if="!value.editing" v-html="value.Description" />
                                ...
                                <td>
                                    <div v-if="!value.new">
                                        ...
                                        <button v-if="!value.editing" title="Delete this label" @click="deleteLabel(value)"
                                            class="btn btn-primary table-icon table-icon-danger">
                                            <i class="fa fa-trash"></i>
                                        </button>
                                        ...
                                        <button v-if="value.editing" title="Undo changes to this label"
                                            @click="cancelEdit(value)" class="btn btn-primary table-icon table-icon-danger">
