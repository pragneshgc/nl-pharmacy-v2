...
class Prescription extends Model
{
    ...
    public function scopeSubstatus(Builder $query, int $status)
    {
        $query->where('SubStatus', $status);
    }

    // Functions ...
    public static function countTodaysDeliveries($countryCode, $deliveryId)
    {
    ...
    public static function orderExists($referenceNumber)
    {
    ...
    public static function updateMessage(int $id, string $message)
    {
