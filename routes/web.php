...
//remove this from checkip

Route::get('/dpd-test', [TestController::class, 'dpdtest']);
...
//Route::post('/new-order', [ImportController::class, 'importOrder']);
Route::get('/order/{id}/download', [OrderController::class, 'download']);
Route::get('/invoice/{id}/show', [InvoiceController::class, 'preview']);
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['routesafetycheck']], function () {
        ...
        Route::get('/order/{id}/xml', [DownloadController::class, 'downloadXML']);
        ...
        Route::post('/invoice/{id}/set-all-complete', [InvoiceController::class, 'setAllComplete']);
        Route::post('/invoice/{id}/set-all-paid ', [InvoiceController::class, 'setAllPaid']);
        Route::post('/invoice/{id}/item', [InvoiceController::class, 'addItem']);
        Route::delete('/invoice/{invoiceid}/item/{itemid}', [InvoiceController::class, 'deleteItem']);
