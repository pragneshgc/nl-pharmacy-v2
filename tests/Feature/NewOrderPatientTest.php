...
class NewOrderPatientTest extends TestCase
{
    ...
    /** @test */
    public function show_error_reference_number_missing_from_xml()
    {
    ...
    /** @test */
    public function show_error_userid_missing_from_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
    ...
    /** @test */
    public function show_error_first_name_missing_from_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function show_error_surname_missing_from_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function show_error_dob_missing_from_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
    ...
    /** @test */
    public function show_error_gender_missing_from_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
        $url = $this->newOrderUrl();
        $overRideXML = [
