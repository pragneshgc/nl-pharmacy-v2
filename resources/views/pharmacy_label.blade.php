        ...
        @for ($i = 1; $i <= $product->Pages; $i++)
            <div style="width: 315px; height: 140px; display: block;">
                    ...
                    <tr>
                        <td style="text-align: center">
                            <div class="product-name"
                                style="display: block; font-size: 14px; text-align: center; margin-top: -3px; @if (strlen($product->Name . ' ' . $product->DisplayedQuantity . ' ' . $product->Units) > 45) font-size: 12.5px; @endif">
                   ...
                   @if ($product->InstructionLength >= 250)
                            ...
                            @php                                   
                                ...
                                foreach ($chunks as $k => $chunk) {
                                    ...
                                    $line_count = ceil(strlen(strip_tags($temp_html)) / 48); // Assuming 50 characters per line
                            ...
                            @foreach ($result as $key => $chunk)
                                <tr>
                                    <td style="height: 70px;vertical-align: top;" >
                                         <div class="product-instructions" style="font-size: 11px; padding: 0px 8px; line-height:12px; font-weight: 700; margin-top: 0px;">                                  
                                            {!! $chunk !!}
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <footer style="position: fixed;top: 5px; bottom: 0px; width:100%"> 
                                            <table class="patient-info" style="width: 100%; font-size: 11px; padding: 0px 5px; height: 20px; position: absolute; bottom: 50px; font-weight: 700;">font-weight: 700;">
                                                    <tr>
                                                        <td>
                                                            <div style="float: left;">
                                                                <span>{{ $prescription->Title }}
                                                                    {{ $prescription->Name }} {{ $prescription->Surname }}</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div style="float: right; position: relative; text-align:right;">
                                                                <b
                                                                    style="
                                                                @if (strlen($prescription->Title . ' ' . $prescription->Name . ' ' . $prescription->Surname) > 37) position: absolute; left: -65px; top: 13px;
                                                                @else
                                                ...
                                                <table class="additional-information" style="width: 100%; height: 40px; position: absolute; bottom: 5px; left: 5px;">
                                                    <tr>
                                                        <td>
                                                            <div
                                                                style="font-size: 9px; display: inline-block; position: relative;margin-top: auto;white-space: normal;flex-grow: 1; width: 100%;">
                                                                <b style="position: absolute; left: 60px; top: -2px;">Keep away from children</b>
                                                                <br>
                                                                <b>{{ $pharmacy->CompanyName }}, {{ $pharmacy->Address1 }},
                                                                    {{ $pharmacy->Address3 }} <br>
                                                                    {{ $pharmacy->Address4 }},{{ $pharmacy->Postcode }},
                                                                    {{ $pharmacy->CodeName }} {{ $pharmacy->Telephone }}</b>
                                                            </div>
                                                        </td>
                                                        <td>
                        ...
                        @else
                            <tr>
                                <td>
                                    <div class="product-instructions" style="font-size: 11px; padding: 0px 5px; line-height:11px; font-weight: 700; margin-top: 0px;">                                  
                                ...
                                <td>
                                    @if (count($product->WarningLabels) > 0)
                                        <div class="product-instructions"
                                            style="font-size: 11px; padding: 0px 5px; line-height:12px; font-weight: 700;">
                                            @foreach ($product->WarningLabels as $label)
                                                {{ $label->Description }}
                                            @endforeach
                                        </div>
                ...
                <footer style="position: fixed;bottom: 0px; height: 40px; width:100%">            
                    <table class="patient-info" style="width: 100%; font-size: 11px; padding: 0px 5px; height: 20px; position: absolute; bottom: 50px; font-weight: 700;">
                        <tr>
                            <td>
                                <div style="float: left;">
    ...
    <div class="footer" style="width: 315px; height: 140px; display: block; position: relative; margin-top: 10px;">
        <table style="width: 100%; text-align:center;">
            ...
            <tr>
                <td>
                    <div
                        style="display:block; text-align: center; padding:0; margin: 0; font-size: 20px; margin-top: 1px; position: absolute; top: 70px; width: 100%;">
            ...
            <div style="display: block;">
                <div style="padding: 5px; width: 150px; box-sizing: border-box; margin-left: 50px; position: relative;">
                    <div
                        ...
                        <img style="vertical-align: top; display: block; height: 80px;" src="{{ $img_src }}"
