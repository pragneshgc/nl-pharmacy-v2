...
-   Add the 'Units' tag (Formulation) as part of the Product Name Mismatch Logic.
...
-   Telephone and company numbers are now taken from the company settings
