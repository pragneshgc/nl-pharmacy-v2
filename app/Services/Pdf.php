...
class Pdf
{
    ...
    protected $command = '%s --headless --disable-gpu --print-to-pdf-no-header --print-to-pdf=%s %s';
     ...
     * @return void
     */
    public function render(int $id, string $url, string $type = 'pdf', $additionalCommand = '')
    {
