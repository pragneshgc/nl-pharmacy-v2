<template>
  <transition name="fade">
    <div
      ...
      aria-modal="true"
    >
      <div class="backdrop" @click="clear()"></div>
      ...
      <div id="product-modal" class="modal" role="document">
        ...
        <div
          class="modal-header"
          v-if="productCodeId && !pricingId && !editing"
          style="
            display: flex;
        ...
        >
          <select
            class="ml-10 browser-default custom-select"
            v-model="productCodeId"
            name="ProductCodeID"
            ...
            >
              <b
                >{{ option.Name
                  ...
                  - {{ option.Code }} - ({{ option.Quantity }})</span
                ></b
              >
            </option>
          </select>
          ...
          >
            ...
            <button
              v-if="productCode.Pack && userInfo.role > 4"
              title="Save product"
              @click="addPackProduct()"
              class="ml-10 btn btnSize02 secondaryBtn"
            >
              ADD Product To Pack
            </button>
        ...
        <div class="modal-body text-center">
          <div class="expand-100 d-flex justify-content-between">
            <div class="row wow fadeIn" style="width: 100%">
              ...
              >
                <h3
                  style="
                    ...
                    margin-top: 15px;
                    padding-bottom: 5px;
                    border-bottom: 3px solid rgb(209 96 96);
                    float: left;
                    width: 100%;
                  "
                >
                ...
                >
                  ...
                  <tr v-if="addedProduct && productCode.Pack">
                    ...
                    <td>
                      <div class="form-group form-group-2">
                        <select
                          ...
                          v-model="addedProduct.Instruction"
                          name="Instruction"
                        >
                    ...
                    <td>
                      <button
                        v-if="
                          productCode.Pack && addedProduct.Description != ''
                        "
                        @click="savePackProduct()"
                        class="btn btn-primary table-icon"
                      >
              ...
              <!-- COUNTRY ADD -->
              <div
                class="pxp-form address-form"
                v-else-if="!productCodeId && type == 'country'"
              >
              ...
              <div
                class="pxp-form address-form"
                v-else-if="type == 'country' && editing"
              >
                <div class="form-row">
                  ...
                  <div class="form-column">
                    ...
                    <div class="form-group form-group-2">
                      ...
                      <select
                        class="browser-default custom-select"
                        v-model="productCodeEdit.Status"
                        name="Status"
                      >
                  ...
                  <div class="form-column">
                    <div class="form-group form-group-2">
                      ...
                      <select
                        class="browser-default custom-select"
                        v-model="productCodeEdit.VAT"
                        name="VAT"
                      >
                        <option value="" disabled>
                          Please select VAT value
                        </option>
                      ...
                      <div v-if="errors.VAT" class="invalid-feedback d-block">
                        {{ errors.VAT[0] }}
                      </div>
                    </div>
                  </div>
              ...
              <div
                class="pxp-form address-form"
                v-else-if="type == 'pricing' && editing"
              >
                <div class="form-column">
                  <div class="form-group form-group-2">
              ...
              <div
                class="pxp-form address-form"
                v-else-if="type == 'product' && editing"
              >
                <div class="form-row">
                  <h3>Basic Information</h3>
                  ...
                  <div class="form-column">
                    ...
                    <div class="form-group form-group-2">
                      ...
                      <input
                        v-model="productCodeEdit.Quantity"
                        type="text"
                        id="Quantity"
                        class="form-control mb-3"
                        placeholder="Quantity"
                    ...
                    <small
                      ...
                      "
                      for="code"
                      >CAUTION : changing this will affect pricing</small
                    >
                  </div>
                  ...
                  <div class="form-column">
                    ...
                    <div class="form-group form-group-2">
                      ...
                      <input
                        v-model="productCodeEdit.Units"
                        type="text"
                        id="Units"
                        class="form-control mb-3"
                        placeholder="Units"
                      />
                      <div v-if="errors.Units" class="invalid-feedback d-block">
                        {{ errors.Units[0] }}
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-column">
                    <div class="form-group form-group-2">
                      ...
                      <input
                        v-model="productCodeEdit.TariffCode"
                        type="text"
                        id="TariffCode"
                        class="form-control mb-3"
                ...
                <div class="form-row">
                  ...
                  <div class="form-column">
                    <div class="form-group form-group-2">
                      ...
                      <select
                        class="browser-default custom-select"
                        v-model="productCodeEdit.ProductType"
                        name="ProductType"
                      >
                    ...
                    <div class="form-group form-group-2">
                      ...
                      <select
                        class="browser-default custom-select"
                        v-model="productCodeEdit.OTC"
                        name="OTC"
                      >
                        <option value="0" selected>POM</option>
                        <option value="1">P</option>
                      </select>
                      <div v-if="errors.OTC" class="invalid-feedback d-block">
                        {{ errors.OTC[0] }}
                      </div>
                    </div>
                    ...
                    <div class="form-group form-group-2">
                      ...
                      <select
                        class="browser-default custom-select"
                        v-model="productCodeEdit.Fridge"
                        name="Fridge"
                      >
                        <option
                          v-if="productCodeEdit.Units == 'SHIPPING'"
                          :value="null"
                        >
                          NOT APPLICABLE
                        </option>
                    ...
                    <div class="form-group form-group-2">
                      ...
                      <select
                        class="browser-default custom-select"
                        v-model="productCodeEdit.PrintForm"
                        name="PrintForm"
                      >
                        <option value="1">Yes</option>
                  ...
                  <div class="form-column">
                    <div class="form-group form-group-2">
                      ...
                      <select
                        class="browser-default custom-select"
                        v-model="productCodeEdit.Pack"
                        name="Pack"
                      >
                        <option value="0" selected>No</option>
                        <option value="1">Yes</option>
                      </select>
                      <div v-if="errors.Pack" class="invalid-feedback d-block">
                        {{ errors.Pack[0] }}
                      </div>
                    </div>
                    ...
                    <small
                      ...
                      for="code"
                    >
                      Is this a package treatment i.e. contains multiple
                      products
                    </small>
                    ...
                    <div class="form-group form-group-2">
                      ...
                      <div v-if="errors.JVM" class="invalid-feedback d-block">
                        {{ errors.JVM[0] }}
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                >
                  <h3
                    style="
                      ...
                      margin-top: 30px;
                      padding-bottom: 5px;
                      border-bottom: 3px solid #b097ff;
                      float: left;
                      width: 100%;
                    "
                  >
                  ...
                  <table class="table table-hover" style="border-bottom: none">
                    ...
                    <tbody>
                      <tr
                        ...
                        :key="name.ProductNameAlternativeID"
                      >
                          ...
                          <button
                            @click="
                              removeAlternativeName(
                                name.ProductNameAlternativeID
                              )
                            "
                            v-if="userInfo.role > 4"
                            title="Remove alternative product name"
                            class="btn btn-primary table-icon"
                          >
                            <i class="fa fa-trash" style="color: white"></i>
                          </button>
                ...
                <!-- ALTERNATIVE UNITS -->
                <div class="col-lg-12 wow fadeIn" v-if="productCodeId && !pricingId && !editing && alternativeUnits.length > 0">
                    <h3 style="text-align: center;margin-top: 30px;padding-bottom: 5px;border-bottom: 3px solid #b097ff;float:left;width: 100%;">Alternative Units/Aliases</h3> 
                    <table class="table table-hover" style="border-bottom: none;">
                        <thead class="primary-color text-white">
                        ...
                        <tbody>
                            <tr v-for="name in alternativeUnits" :key="name.UnitAlternativeID">
                                ...
                                <td>{{ name.CreatedAt }}</td>
                                <td>
                                    <button @click="removeAlternativeUnit(name.UnitAlternativeID)" v-if="userInfo.role > 4" title="Remove alternative product unit" class="btn btn-primary table-icon">
                                        <i class="fa fa-trash" style="color: white;"></i>
                                    </button>
                                </td>
                            </tr>
                ...
                <div
                  class="col-lg-12 wow fadeIn"
                  v-if="
                    productCodeId && !pricingId && !editing && logs.length > 0
                  "
                >
                  <h3
                    style="
                      ...
                      margin-top: 30px;
                      padding-bottom: 5px;
                      border-bottom: 3px solid #77c187;
                      float: left;
                      width: 100%;
                    "
                  >
                ...
                <div
                  class="col-lg-12 wow fadeIn"
                  v-if="packs.length > 0 && !pricingId && !editing"
                >
                  <h3
                    style="
                      text-align: center;
                    ...
                    "
                  >
                    This product is part of the following packaged products
                  </h3>
                  <table class="table table-hover" style="border-bottom: none">
                    <thead class="primary-color text-white">
                      <th>Code</th>
                    ...
                    <tbody>
                      <tr v-for="pack in packs" :key="pack.ProductCodeID">
                        ...
                        <td>
                          <a
                            target="_blank"
                            :href="`/#/products?code=${pack.ProductCodeID}`"
                            >View (New Tab)</a
                          >
                        </td>
                      </tr>
        ...
        <div class="modal-footer">
          <button
            v-if="
              ...
              ((type == 'product' && !isEqual(productCode, productCodeEdit)) ||
                (type == 'country' &&
                  !isEqual(form.country, form.bufferCountry)) ||
                type == 'pricing')
            "
            :disabled="saving"
            @click="save()"
          ...
          <button
            v-if="editing && productCodeId && userInfo.role > 4"
            :disabled="saving"
            @click="back(productCode.Type)"
            type="button"
            class="btn btnSize02 secondaryBtn"
          >
            Back
...
export default {
  ...
  mounted() {
    this.$root.$on('product.details', this.getProductDetails);
    this.$root.$on('product.add', this.addProduct);
    this.$root.$on('country.details', this.getCountryDetails);
    this.$root.$on('country.add', this.addCountry);
    this.clear();
  },
  beforeDestroy() {
    this.$root.$off('product.details', this.getProductDetails);
    this.$root.$off('product.add');
    this.$root.$off('country.details', this.getCountryDetails);
    this.$root.$off('country.add');
  ...
  watch: {
    ...
    productCode() {
      if (
        typeof this.productCode.Type != 'undefined' &&
        this.productCode.Type == 2
      ) {
        this.type = 'country';
      }
    },
  ...
  methods: {
    ...
    getPriceList() {
      axios
        .get(`/inventory/products/${this.productCodeId}/list`)
        .then((response) => {
    ...
    getAlternativeNamesList() {
      axios
        .get(`/inventory/products/${this.productCodeId}/alternative-names`)
        .then((response) => {
    ...
    getLogs() {
      axios
        .get(`/inventory/products/${this.productCodeId}/logs`)
        .then((response) => {
    ...
    getProductCode() {
      axios
        .get(`/inventory/products/${this.productCodeId}`)
        .then((response) => {
    ...
    getPacks() {
      axios
        .post(`/inventory/products/packs`, { code: this.productCode.Code })
        .then((response) => {
    ...
    removePricing(value) {
      this.$swal({
        ...
        if (result.value) {
          axios
            .delete(`/inventory/products/pricing/${value.PricingID}`)
            .then((result) => {
              this.$swal({
              ...
              this.logSystemActivity(
                this.productCode.ProductCodeID,
                5,
                800,
                value,
                () => {
    ...
    savePackProduct() {
      axios
        .post(`/inventory/products/pack`, this.addedProduct)
        .then((response) => {
          this.logSystemActivity(
            this.productCodeId,
            5,
    ...
    removeProduct(id) {
      this.$swal({
        ...
        if (result.value) {
          axios
            .delete(`/inventory/products/pack/${id}`)
            .then((result) => {
              this.$swal({
    ...
    removeAlternativeName(id) {
      this.$swal({
        ...
        if (result.value) {
          axios
            .delete(`/inventory/products/alternative-names/${id}`)
            .then((result) => {
              this.$swal({
    ...
    deleteProduct() {
      this.$swal({
        ...
        if (result.value) {
          axios
            .delete(`/inventory/products/${this.productCodeId}/delete`)
            .then((result) => {
              this.$swal({
    ...
    reactivateProduct() {
      this.$swal({
        ...
        if (result.value) {
          axios
            .post(`/inventory/products/${this.productCodeId}/reactivate`)
            .then((result) => {
              this.$swal({
    ...
    save() {
      if (!this.productCodeId && this.type == 'country') {
        axios
          .post(`/inventory/countries/pricing`, this.form.country)
          .then((result) => {
            this.$swal({
        ...
        axios
          .post(`/inventory/products/pricing`, form)
          .then((result) => {
            this.$swal({
              title: 'Pricing added',
              type: 'success',
        ...
        this.pricingId &&
        (this.type == 'country' || this.type == 'product')
      ) {
        axios
          .patch(
            `/inventory/countries/pricing/${this.pricingId}`,
            this.form.country
          )
          .then((result) => {
            this.$swal({
        ...
        axios
          .patch(
            `/inventory/products/${this.productCodeId}`,
        ...
        axios
          .post(`/inventory/products`, this.productCodeEdit)
          .then((result) => {
            this.$swal({
              title: 'Product added',
              type: 'success',
    ...
    checkFields(callback) {
      ...
      if (
        ...
        this.selectedItem.FMDExpiryDate == null ||
        !/[\d]{2}\/[\d]{4}/.test(this.selectedItem.FMDExpiryDate)
      ) {
      ...
      this.errors.FMDBatchID =
        this.selectedItem.FMDBatchID == '' ||
        this.selectedItem.FMDBatchID == null
          ? true
          : false;
    ...
    changeStatus(value) {
      axios
        .post(`/inventory/products/pack/${value.PackProductID}/change-status`)
        .then((result) => {
    ...
    finishMove(e) {
      this.dragging = false;
      axios
        .post(`/inventory/products/pack/ordering`, { list: this.list })
        .then((response) => {
