...
class NewOrderCredentialXmlTest extends TestCase
{
    ...
    /** @test */
    public function show_unauthorize_error_for_not_whitelisted_ip()
    {
    ...
    /** @test */
    public function show_unauthorize_error_for_invalid_username()
    {
    ...
    /** @test */
    public function show_unauthorize_error_for_invalid_password()
    {
        $client = $this->addClient();
        $data = [
    ...
    /** @test */
    public function show_unauthorize_error_for_invalid_apikey()
    {
        $client = $this->addClient();
        $data = [
            'USERNAME' => $client->Username,
    ...
    /** @test */
    public function show_error_for_empty_xml()
    {
    ...
    /** @test */
    public function show_error_for_invalid_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
...
<ESAPrescription>
    ...
    /** @test */
    public function show_error_if_patient_details_missing_from_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
    ...
    /** @test */
    public function show_error_if_patient_details_patient_missing_from_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
    ...
    /** @test */
    public function show_error_if_prescription_data_missing_from_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
    ...
    /** @test */
    public function show_error_if_date_missing_from_xml()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.1.0.1']);
