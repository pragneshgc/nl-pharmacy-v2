<template>
    ...
    <div class=" natcol-table" :class="[columnClass]">
        ...
        <div class="">
            <div class="">
                <div v-if="filters.length != 0" class="row search-boxes">
                    <div v-for="(filter, index) in filters" :key="index" class="filter-inputs">
                        ...
                        <treeselect v-else-if="filter.type == 'select-extended'" class="vue-treeselect-reports"
                            ...
                            :append-to-body="false" :options="filter.options" :instanceId="filter.value" @open="selectOpen"
                            v-model="selectedFilters[filter.value]">
                ...
                <div v-if="filters.length != 0" class="row filters-row">
                    ...
                    <div>
                        ...
                        <button title="Store current filers for later use"
                            :disabled="loading || (filterRequired && noSelectedFilters)" class="btn btnSize02 tertiaryBtn"
                            @click="saveFilters()">Save Filters</button>
                ...
                <div class="row filters-row">
                    ...
                    <div class="dropdown float-right">
                        ...
                        <a title="Download results as PDF" class="btn btn-primary waves-effect" v-on:click="exportPDF($el)">
            ...
            <PaginationComponent class="card-footer" style="border-top: 1px solid #8f8f8f;" :data="data" :loading="loading"
                :custom-total="customTotal" :custom-paginate="customPaginate" @click="changePage">
            ...
            <div class="card-body" style="min-height: 100px;">
                ...
                <table style="table-layout: auto;" v-show="data.data.length >= 1" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="clickable" @dblclick="openInTab(item[redirectId])" v-for="item in data.data"
                            :key="item[Object.keys(item)[0]]" :class="[item['NotFound'] == true ? 'row-danger' : '']">
