        ...
        <ul class="sidebar">
            <li class="sidebarSection parentActive">
                ...
                <ul class="nav">
                    ...
                    <router-link title="Products" v-if="userInfo.role == 4 || userInfo.role == 20 || userInfo.role >= 30"
                        tag="li" to="/products" exact>
                        <a href="javascript:;" class="sidebar-link">
                    ...
                    <router-link title="Settings" v-if="userInfo.role == 19 || userInfo.role == 20 || userInfo.role >= 30"
                        tag="li" to="/settings" exact>
                        <a href="javascript:;" class="sidebar-link">
