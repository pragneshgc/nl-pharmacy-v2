             ...
             @for ($i = 1; $i <= $product->Pages; $i++)
                <div style="width: 100%; height: 160px;">
                    ...
                    <div class="product-instructions">
                        <p class="instructions">{{ $product->Instructions }}</p>
                        @if (count($product->WarningLabels) > 0)
                            <div class="warnings">
                                @foreach ($product->WarningLabels as $label)
                                    {{ $label->Description }}
                    ...
                    <footer
                       ...
                       @elseif ($product->InstructionLength >= 630) 
                                    ...
                                    <table class="w-100" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr style="vertial-align:middle;">
                                            <td style="vertical-align: top">
                                                ...
                                                <p class="fs-9">
                                                    {{ $pharmacy->CompanyName }}, {{ $pharmacy->Address1 }},
                                                    {{ $pharmacy->Address3 }} <br>
                                                    {{ $pharmacy->Address4 }},{{ $pharmacy->Postcode }},
                                                    {{ $pharmacy->CodeName }} {{ $pharmacy->Telephone }}
                                                </p>
                                            </td>
