...
class PrescriptionService
{
    ...
    {
        if (isset($list['Prescription.Prescriber.Doctor.GMCNO'])) {
            $required = [
            ...
            $required = [
                "Prescription.Prescriber.Doctor.RegistrationNo",
                //"Prescription.Prescriber.Doctor.DoctorName",
            ];
        }
    ...
    private function setPrescriber($prescription)
    {
        ...
        $this->data['GMCNO'] = $prescription['Prescriber']['Doctor']['GMCNO'] ?? $prescription['Prescriber']['Doctor']['RegistrationNo'];
    ...
    private function setDoctor($prescription)
    {
        ...
        $registrationNo = $prescription['Prescriber']['Doctor']['GMCNO'] ?? $prescription['Prescriber']['Doctor']['RegistrationNo'];
        $doctorData = Doctor::query()
            ->where('GMCNO', $registrationNo)
            ->first();
    ...
    public function saveXML($id = false, $file)
    {
